    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(error_messages={'unique': 'A user with that email already exists.'}, help_text='Required. Avalid unique email id.', max_length=254, unique=True, verbose_name='email address')),
